 ...
 */
package com.mgmtp.perfload.core.web.ssl;
...
public class LtSSLSocketFactory implements LayeredSchemeSocketFactory {
	...
	/**
	 * @param keyStoreUrl
	 *            URL of the key store file. May be <tt>null</tt> if HTTPS client authentication is not to be used.
	 * @param keyStorePassword
	 *            Password to unlock the key store. IMPORTANT: this implementation assumes that the same password is used to
	 *            protect the key and the key store itself.
	 * @param keyStoreType
	 *            Type of the key store, e. g. jks, PKCS12 (default is jks)
	 * @param trustStoreUrl
	 *            URL of the trust store file. May be <tt>null</tt> if HTTPS server authentication is not to be used.
	 * @param trustStorePassword
	 *            Password to unlock the trust store.
	 * @param trustStoreType
	 *            Type of the trust store, e. g. jks, PKCS12 (default is jks)
	 */
	public LtSSLSocketFactory(final URL keyStoreUrl, final String keyStorePassword, final String keyStoreType,
	        final URL trustStoreUrl, final String trustStorePassword, final String trustStoreType) {
	...
	private KeyManager[] createKeyManagers(final KeyStore keyStore, final char[] password) throws KeyStoreException,
