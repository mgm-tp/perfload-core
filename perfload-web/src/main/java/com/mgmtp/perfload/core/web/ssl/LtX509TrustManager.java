...
/**
 * {@link X509TrustManager} implementation for SSL and client authentication. Acts as a decorator to the *
 * {@link X509TrustManager} passed in by the constructor in order to add logging.
 * 
 * @author rnaegele
 */
